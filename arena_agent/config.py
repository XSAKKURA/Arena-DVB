...
class Settings:
    ...
    # живых матчах отвечаем быстро из вежливости; у заочных на ход есть сутки,
    # поэтому там думаем заметно дольше — в шахматах и шашках это прямо
    # переводится в силу игры. Поток один, но живой дедлайн в 15 минут такую
    # задержку переживает с запасом.
    live_think_seconds: float = 3.0
    async_think_seconds: float = 20.0
