...
Классический приём — охотиться только по решётке, где (r + c) кратно длине
наименьшего уцелевшего корабля, — здесь ничего не даёт и потому не встроен:
на 400 досках разница составила +0,01 ± 0,03 выстрела. Причина в том, что
карта плотности приходит к тому же ответу сама: клетка вне решётки покрывает
не больше расстановок, чем клетка на ней, и максимума не достигает.
"""
